...
const features = [
  ...
  {
    icon: CreditCard,
    title: "Հարմար տեղական վճարումներ",
    description:
      "Համալրեք դրամապանակը ձեզ հարմար եղանակով և վճարեք միայն անհրաժեշտ քայլերի համար՝ պարզ, թափանցիկ և տեղական շուկային հարմարեցված։",
  },
];
