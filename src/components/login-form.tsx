  ...
  useEffect(() => {
    ...
    const messages: Record<string, string> = {
      OAuthAccountNotLinked:
        "Այս email-ով հաշիվ արդեն կա։ Մուտք գործեք հեռախոսով կամ օգտագործեք նույն Google հաշիվը։",
      AccessDenied: "Մուտքը մերժվել է։",
      Configuration: "Google մուտքը կարգավորված չէ սերվերի վրա։",
      Default: "Google մուտքը չհաջողվեց։ Կրկին փորձեք։",
    };
    const msg = messages[oauthError] ?? messages.Default;
    setError(msg);
    toastError("Google մուտք", msg);
  }, [searchParams]);
