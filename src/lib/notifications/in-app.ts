...
export const NOTIFICATION_KINDS = {
  ...
  CONTRACT_PROPOSED_TO_PROVIDER: "CONTRACT_PROPOSED_TO_PROVIDER",
  CONTRACT_AWAITING_CLIENT: "CONTRACT_AWAITING_CLIENT",
  CONTRACT_AWAITING_PROVIDER: "CONTRACT_AWAITING_PROVIDER",
  CONTRACT_ACCEPTED: "CONTRACT_ACCEPTED",
  CONTRACT_CANCELLED: "CONTRACT_CANCELLED",
  TENDER_PEER_MESSAGE: "TENDER_PEER_MESSAGE",
